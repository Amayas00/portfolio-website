...
const projects = [
  ...
  },
  {
    ...
    description:
      "Développement front-end d'un site web universitaire complet. Structuration des pages, amélioration de l'expérience utilisateur et intégration de contenus dynamiques en JavaScript.",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mx-auto max-w-3xl mb-16">
          ...
          <p className="text-muted-foreground animate-fade-in animation-delay-200">
            Une sélection de mes projets académiques, alliant conception
            rigoureuse, développement orienté objet et interfaces fonctionnelles.
          </p>
        </div>
          ...
          {projects.map((project, idx) => (
            <div
              ...
              className={`group glass rounded-2xl overflow-hidden animate-fade-in ${
                idx === 2 ? "md:col-span-2 md:max-w-2xl md:mx-auto w-full" : ""
              }`}
